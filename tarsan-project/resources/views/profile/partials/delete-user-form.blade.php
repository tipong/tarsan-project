<section>
    <header class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500">
            Once your account is deleted, all data will be permanently deleted. Please consider carefully before proceeding.
        </p>
    </header>
    ...
    <div id="deleteAccountModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <form method="post" action="{{ route('profile.destroy') }}" class="space-y-4">
                ...
                <div>
                    <label for="delete_password" class="block text-sm font-medium text-gray-700 mb-1">Enter Password</label>
                    <input
                        id="delete_password"
                        name="password"
                        type="password"
