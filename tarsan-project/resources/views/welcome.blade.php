...
<nav class="bg-white shadow-md fixed w-full z-50">
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <a href="{{ url('/') }}" class="flex items-center gap-2">
            <img src="{{ asset('images/tarsanhomestay.png') }}" class="h-20">
            <span class="font-bold">Tarsan Homestay</span>
        </a>
    ...
    @auth
        <a href="{{ route('tamu.orders') }}" class="hover:text-blue-600">
            Pesanan Saya
        </a>
    @endauth
    </div>
        ...
        <div class="space-x-3">
            ...
            @else
                <form method="POST" action="{{ route('logout') }}" class="inline">
                    @csrf
                    <button class="px-4 py-2 text-red-600">
                        Logout
                    </button>
                </form>
            @endguest
...
>
    ...
    The Best Stay Experience<br>In Labuan Bajo</h1>
    ...
    Book your room easily, quickly, and securely directly with us.
        ...
        {{-- SEARCH BOX --}}
        <div class="bg-white p-4 rounded shadow-md flex flex-col md:flex-row gap-4 text-black">
