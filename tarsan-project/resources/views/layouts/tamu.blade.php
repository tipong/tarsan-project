...
<nav class="bg-white/90 backdrop-blur-md shadow fixed w-full z-50 transition-all border-b border-slate-200">
    <div x-data="{ mobileMenuOpen: false }" class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        {{-- LOGO --}}
        ...
        <div class="hidden md:flex items-center space-x-8 text-sm font-medium">
            ...
            @auth
                <!-- <a href="{{ route('tamu.orders') }}" class="text-slate-600 hover:text-slate-900 transition-colors">My Order</a> -->
            @endauth
            <a href="{{ url('/') }}#kontak" class="text-slate-600 hover:text-slate-900 transition-colors">Contact</a>
        </div>
        ...
        <div class="flex items-center gap-4">
            <div class="hidden md:flex items-center gap-4">
                ...
                @auth
                    ...
                    <a href="{{ route('tamu.booking.index') }}" class="mr-4 px-5 py-2 bg-slate-900 text-white text-sm font-medium rounded-full hover:bg-slate-800 transition shadow-md">Book</a>
        ...
        <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" 
            ...
            <a href="{{ route('tamu.dashboard') }}" class="block text-slate-600 hover:text-slate-900">Home</a>
            <a href="#tentang" class="block text-slate-600 hover:text-slate-900">About</a>
            <a href="#fasilitas" class="block text-slate-600 hover:text-slate-900">Facilities</a>
            <a href="{{ route('kamar.index') }}" class="block text-slate-600 hover:text-slate-900">Rooms</a>
            @auth
                <!-- <a href="{{ route('tamu.orders') }}" class="block text-slate-600 hover:text-slate-900">My Order</a> -->
                <a href="{{ route('tamu.booking.index') }}" class="block text-slate-600 hover:text-slate-900">Book Now</a>
...
<footer id="kontak" class="bg-slate-950 text-slate-500 py-16">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12 text-sm font-light">
        ...
        <div>
            ...
            <ul class="space-y-3">
                <li>
                    <a href="{{ route('tamu.dashboard') }}" class="hover:text-white transition-colors">
                        Home
                    </a>
                </li>
                <li>
