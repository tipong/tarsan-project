...
<head>
    ...
    <style>
        ...
        .btn-dark{padding:8px 22px;border:1px solid #1a1a1a;background:#1a1a1a;color:#fff;font-size:11px;font-weight:500;letter-spacing:.12em;text-transform:uppercase;text-decoration:none;transition:all .3s;cursor:pointer;font-family:'Inter',sans-serif;display:inline-block}
        .btn-dark:hover{background:#333;border-color:#333}
        .btn-fill{padding:8px 22px;border:1px solid #1a1a1a;color:#1a1a1a;font-size:11px;font-weight:500;letter-spacing:.12em;text-transform:uppercase;text-decoration:none;transition:all .3s;background:transparent;cursor:pointer;font-family:'Inter',sans-serif;display:inline-block}
        .btn-fill:hover{background:#1a1a1a;color:#fff}

        @media print {
            body { background: #fff; padding: 0; }
            .inv-wrap { border: none; padding: 0; margin: 0; width: 100%; }
...
<body>
    ...
    <div class="inv-actions">
        ...
        <button onclick="window.close()" class="btn-fill">✕ Close Window</button>
    </div>
